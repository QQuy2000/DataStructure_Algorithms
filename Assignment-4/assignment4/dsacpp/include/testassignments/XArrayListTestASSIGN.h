...
#ifndef XARRAYLISTTESTASSIGN_H
#define XARRAYLISTTESTASSIGN_H
...
TEST_CASE( "XArrayList<int>: appending items = add(*)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: add first = add(0, *)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: add last = add(size, *)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: add at k (random)= add(k, *)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
//Removal tests
TEST_CASE( "XArrayList<int>: remove the first item = removeAt(0)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: remove the last item = removeAt(size-1)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: remove at k (random) = removeAt(k)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: removeItem = removeItem(item)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
//test get
TEST_CASE( "XArrayList<int>: get item at  = get(k)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: indexOf(item)" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "XArrayList<int>: contains" ) {
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE("XArrayList<int>: iterator -> remove"){
    XArrayList<int> list;
    REQUIRE( list.size() == 0 );
